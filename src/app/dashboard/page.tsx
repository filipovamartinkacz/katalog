      ...
      {medailonek ? (
        ...
        <div className="mt-6 flex flex-col gap-4">
          <div className="rounded-2xl border border-border bg-card p-6">
            <h2 className="font-semibold">Staň se viditelnou v katalogu</h2>
            <p className="mt-2 text-sm text-muted-foreground">
              Vytvoř si profil a zákaznice tě snadno najdou. Vyplnění zabere asi 10 minut.
            </p>
            <Link href="/dashboard/medailonek/novy" className={buttonVariants({ size: 'sm' }) + ' mt-4'}>
              Vytvořit profil
            </Link>
          </div>
          ...
          <div className="rounded-2xl border border-border bg-card p-6 opacity-60">
            ...
            <p className="mt-2 text-sm text-muted-foreground">Brzy zde nastavíš odběr novinek.</p>
          </div>
        </div>
      )}
    </div>
